...
The goal of this solution is to provide a working demo for deploying AppStack and Virtual Kubernetes (vk8s) on GCP in multiple regions with multiple zones.
<!--TOC-->
