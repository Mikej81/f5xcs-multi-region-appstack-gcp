...
The goal of this solution is to provide the infrastructure for a working demo for deploying F5 Distributed Cloud AppStack and Virtual Kubernetes (vk8s) on GCP in multiple regions with multiple zones.
<!--TOC-->
